package com.challenge.sermaluc.usuarios.adapter.database.repository;
...
public interface UserRepository extends JpaRepository<User, String> {
    ...
    @Query(
            "SELECT new com.challenge.sermaluc.usuarios.adapter.controller.model.outbound.UserDTO(" +
                    "u.userId, " +
                    "u.name, " +
                    "u.username, " +
                    "u.status) " +
   ...
   @Query(" SELECT new com.challenge.sermaluc.usuarios.adapter.controller.model.Phones(" +
            "p.number, " +
            "p.cityCode, " +
            "p.countryCode " +
            ") " +
