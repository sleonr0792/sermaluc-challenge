package com.challenge.sermaluc.usuarios.domain.usecase.validator;
...
public class UserValidatorServiceImpl implements  UserValidatorService {
    ...
    /**
     *  esta funcion sirve para verificar si el email del usuarios ha sido registrado anteriormente
     * @param email
     */
    @Override
