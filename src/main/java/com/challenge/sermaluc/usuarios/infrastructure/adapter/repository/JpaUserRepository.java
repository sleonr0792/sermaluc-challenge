package com.challenge.sermaluc.usuarios.infrastructure.adapter.repository;
...
public interface JpaUserRepository extends JpaRepository<User, String> {
    ...
    @Query(
            "SELECT new com.challenge.sermaluc.usuarios.infrastructure.adapter.dto.output.UserResponse(" +
                    "u.userId, " +
                    "u.name, " +
                    "u.username, " +
                    "u.status) " +
   ...
   @Query(" SELECT new com.challenge.sermaluc.usuarios.infrastructure.adapter.dto.output.PhoneResponse(" +
            "p.number, " +
            "p.cityCode, " +
            "p.countryCode " +
            ") " +
